...
<style>
    ...
    .bg-dark-orange {
        background-color: #dc4501 !important;
        color: #fff !important;
    }
    .badge {
        font-size: 1rem;
                    ...
                    <tr>
                        ...
                        <td>
                            @switch($laporan->status)
                                @case('diajukan')
                                    <span class="badge bg-light-gray">Diajukan</span>
                                    @break
                                @case('diverifikasi')
                                    <span class="badge bg-warning">Diverifikasi</span>
                                    @break
                                @case('diterima')
                                    <span class="badge bg-light-blue">Diterima</span>
                                    @break
                                @case('ditolak')
                                    <span class="badge bg-light-danger">Ditolak</span>
                                    @break
                                @case('ditindaklanjuti')
                                    <span class="badge bg-dark-orange">Ditindaklanjuti</span>
                                    @break
                                @case('ditanggapi')
                                    <span class="badge bg-dark-orange">Ditanggapi</span>
                                    @break
                                @case('selesai')
