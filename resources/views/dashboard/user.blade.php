                ...
                <div class="notification-wrapper">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-0" style="width: 320px;">
                            ...
                            <li>
                                <div id="notification-list" class="list-group">
                                    @forelse (Auth::user()->notifications->take(3) as $notification)
                                        <a href="{{ route('laporan.show', $notification->data['laporan_id']) }}"
                                            class="list-group-item list-group-item-action {{ $notification->read_at ? '' : 'bg-light' }}">
                                            <div class="d-flex w-100 justify-content-between">
                                                <p class="mb-1 fw-semibold text-dark text-truncate" style="max-width: 200px;">
                            ...
                            <li class="dropdown-footer text-center py-2 border-top bg-light">
                                <a href="{{ route('notifications.index') }}" class="text-primary">Lihat semua notifikasi</a>
                            </li>
                        </ul>
                    </div>
                </div>
