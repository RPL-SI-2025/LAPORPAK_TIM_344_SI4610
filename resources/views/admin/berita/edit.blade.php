        ...
        <div class="card-body">
            <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('tanggal_terbit') is-invalid @enderror" id="tanggal_terbit" name="tanggal_terbit" value="{{ old('tanggal_terbit', $berita->tanggal_terbit->format('Y-m-d')) }}" required>
                ...
                <div class="mb-3">
                    ...
                    @if($berita->gambar)
                    <div class="mb-2">
                        <img src="{{ Storage::url($berita->gambar) }}" alt="Current Image" style="max-height: 200px;">
                    </div>
                    @endif
                    <input type="file" class="form-control @error('gambar') is-invalid @enderror" id="gambar" name="gambar" accept="image/*">
                    <small class="text-muted">Biarkan kosong jika tidak ingin mengubah gambar. Ukuran maksimal 2MB. Format: JPG, JPEG, PNG</small>
                    @error('gambar')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
