...
<head>
  ...
  <title>@yield('title', 'LaporPak Admin')</title>
  ...
  <div class="main-wrapper">
    <div class="sidebar">
      ...
      <ul>
        ...
        <li><a href="{{ route('admin.laporan.index') }}" class="{{ request()->routeIs('admin.laporan.*') ? 'active' : '' }}"><i class="bi bi-chat-left-text"></i> <span>Laporan</span></a></li>
