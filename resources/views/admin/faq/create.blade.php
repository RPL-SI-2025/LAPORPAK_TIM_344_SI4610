            ...
            <form id="faqForm" action="{{ route('admin.faq.store') }}" method="POST">
                ...
                <div style="margin-bottom:18px;">
                    ...
                    <textarea
                        ...
                        rows="4"
                        required
                        style="width:100%; border:2px solid #FFB84C; border-radius:10px; padding:14px 12px; font-size:1rem; font-family:'Poppins', 'Roboto', Arial, sans-serif; color:#333; background:#fff; resize:vertical; box-sizing:border-box; max-height:200px; overflow-y:auto;"
