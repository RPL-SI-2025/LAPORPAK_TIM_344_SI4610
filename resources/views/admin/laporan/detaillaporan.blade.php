                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <div class="status-timeline d-flex justify-content-between align-items-center position-relative">
                                ...
                                <div class="timeline-item {{ in_array($laporan->status, ['diajukan', 'diverifikasi', 'ditolak', 'diterima', 'ditindaklanjuti', 'ditanggapi', 'selesai']) ? 'done' : '' }}">
                                    <span class="timeline-icon"><i class="fas fa-edit"></i></span>
                                    <span class="timeline-title">Tulis Laporan</span>
                                </div>

                                <div class="timeline-item {{ in_array($laporan->status, ['diverifikasi', 'ditolak','diterima', 'ditindaklanjuti', 'ditanggapi', 'selesai']) ? 'done' : '' }}">
                                    <span class="timeline-icon"><i class="fas fa-search"></i></span>
                                    <span class="timeline-title">Proses Verifikasi</span>
                                </div>
                                
                                <div class="timeline-item {{ $laporan->status == 'ditolak' ? 'done' : '' }}">
                                    <span class="timeline-icon"><i class="fas fa-times-circle"></i></span>
                                    <span class="timeline-title">Ditolak</span>
                                </div>

                                <div class="timeline-item {{ in_array($laporan->status, ['diterima', 'ditindaklanjuti', 'ditanggapi', 'selesai']) ? 'done' : '' }}">
                                    <span class="timeline-icon"><i class="fas fa-check"></i></span>
                                    <span class="timeline-title">Diterima</span>
                                </div>
