...
class LaporanController extends Controller
{
    ...
    public function updateStatus(Request $request, Laporan $laporan)
    {
        ...
        return redirect()->back()->with('success', 'Status laporan berhasil diperbarui & notifikasi dikirim.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with('success', 'Status berhasil diperbarui dan notifikasi dikirim.');
    }
